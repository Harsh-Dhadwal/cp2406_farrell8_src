package DebuggingExercises;// Program reads in a file of phone numbers without area codes
...
public class DebugThirteen2 {
    public static void main(String[] args) {
        ...
        Path pathToProject = Paths.get("DebuggingExercises");
        String s = pathToProject.toAbsolutePath().toString();

        Path fileIn =
                Paths.get(s + "/DebugData3.txt");
        Path fileOut =
                Paths.get(s + "/DebugData3New.txt");
        String areaCode = "(312) ";
        String phone;
